...
(function (b) {
    ...
    a.prototype = {constructor: a, initInput: function () {
            ...
            g.stopPropagation();
            g.preventDefault();
            var c, f = this.input.input2value();
            if (c = this.validate(f)) {
                this.error(c);
                this.showForm();
                return
            }
...
(function (c) {
    ...
    b.prototype = {containerName: null, containerDataName: null, innerCss: null, containerClass: "editable-container editable-popup", init: function (e, d) {
            this.$element = c(e);
...
(function (b) {
    ...
    a.prototype = {constructor: a, init: function () {
            ...
            if (c !== undefined) {
                ...
                if (b.trim(this.$element.html()) === "") {
                    this.isEmpty = true
                } else {
                    if (b.trim(this.$element.text()) !== "") {
                        this.isEmpty = false
                    } else {
    ...
    b.fn.editable = function (h) {
        ...
        switch (h) {
            ...
            case"getValue":
                if (arguments.length === 2 && arguments[1] === true) {
                    c = this.eq(0).data(e).value
                } else {
                    this.each(function () {
                        var l = b(this), k = l.data(e);
                        if (k && k.value !== undefined && k.value !== null) {
                            c[k.options.name] = k.input.value2submit(k.value)
                        }
                    })
                }
                return c;
            case"submit":
                var f = arguments[1] || {}, j = this, i = this.editable("validate"), d;
                if (b.isEmptyObject(i)) {
                    d = this.editable("getValue");
                    if (f.data) {
                        b.extend(d, f.data)
                    }
                    b.ajax(b.extend({url: f.url, data: d, type: "POST"}, f.ajaxOptions)).success(function (k) {
                        if (typeof f.success === "function") {
                            f.success.call(j, k, f)
                        }
                    }).error(function () {
                        if (typeof f.error === "function") {
                            f.error.apply(j, arguments)
                        }
                    })
                } else {
                    if (typeof f.error === "function") {
        ...
        return this.each(function () {
            var m = b(this), l = m.data(e), k = typeof h === "object" && h;
            if (k && k.selector) {
                l = new a(this, k);
                return
            }
            if (!l) {
                m.data(e, (l = new a(this, k)))
            }
            if (typeof h === "string") {
                l[h].apply(l, Array.prototype.slice.call(g, 1))
            }
        })
    };
...
(function (b) {
    ...
    a.defaults = {tpl: "", inputclass: "input-medium", scope: null, showbuttons: true};
...
(function (b) {
    ...
    b.extend(a.prototype, {render: function () {
            ...
            return c.promise()
        }, onSourceReady: function (i, d) {
            var f;
            if (b.isFunction(this.options.source)) {
                f = this.options.source.call(this.options.scope);
            ...
            try {
                f = b.fn.editableutils.tryParseJson(f, false)
            } catch (h) {
                d.call(this);
                return
            }
            if (typeof f === "string") {
                ...
                b.ajax({url: f, type: "get", cache: false, dataType: "json", success: b.proxy(function (e) {
                        if (c) {
                            c.loading = false
                        }
    ...
    a.defaults = b.extend({}, b.fn.editabletypes.abstractinput.defaults, {source: null, prepend: false, sourceError: "Error when loading list", sourceCache: true});
...
(function (a) {
    ...
    a.extend(b.prototype, {render: function () {
            ...
            this.$input.val(e).trigger("change", true);
            if (this.isRemote && !this.isMultiple && !this.options.select2.initSelection) {
                var f = this.options.select2.id, c = this.options.select2.formatSelection;
                if (!f && !c) {
                    var d = {id: e, text: a(this.options.scope).text()};
                    this.$input.select2("data", d)
                }
            }
        }, input2value: function () {
...
(function (b) {
    ...
    a.prototype = {constructor: a, init: function () {
            ...
            b.each(this.map, function (g, e) {
                var h = c.$widget.find("." + g), i, d;
                if (h.length) {
                    c["$" + g] = h;
                    i = "fill" + g.charAt(0).toUpperCase() + g.slice(1);
                    d = c[i]();
            ...
            c = this.initItems("y").concat(c);
            return c
        }, fillHour: function () {
            var e = this.initItems("h"), f, h, k = this.options.template.indexOf("h") !== -1, j = this.options.template.indexOf("H") !== -1, d = this.options.template.toLowerCase().indexOf("hh") !== -1, g = k ? 1 : 0, c = k ? 12 : 23;
            for (h = g; h <= c; h++) {
    ...
    b.fn.combodate.defaults = {format: "DD-MM-YYYY HH:mm", template: "D / MMM / YYYY   H : mm", value: null, minYear: 1970, maxYear: 2015, yearDescending: true, minuteStep: 5, secondStep: 1, firstItem: "empty", errorClass: null, roundTime: true}
}(window.jQuery));
(function (a) {
    var b = function (c) {
...
(function (a) {
    a.extend(a.fn.editableform.Constructor.prototype, {initTemplate: function () {
...
(function (a) {
    a.extend(a.fn.editableContainer.Popup.prototype, {containerName: "popover", innerCss: a.fn.popover && a(a.fn.popover.Constructor.DEFAULTS.template).find("p").length ? ".popover-content p" : ".popover-content", initContainer: function () {
            a.extend(this.containerOptions, {trigger: "manual", selector: false, content: " ", template: a.fn.popover.Constructor.DEFAULTS.template});
            var b;
            ...
            (function () {
                var g = this.tip(), e, j, b, h, f, k, c, l, i, d;
                f = typeof this.options.placement === "function" ? this.options.placement.call(this, g[0], this.$element[0]) : this.options.placement;
                e = /in/.test(f);
                g.removeClass("top right bottom left").css({top: 0, left: 0, display: "block"});
                j = this.getPosition(e);
                b = g[0].offsetWidth;
                h = g[0].offsetHeight;
                f = e ? f.split(" ")[1] : f;
                l = {top: j.top + j.height, left: j.left + j.width / 2 - b / 2};
                c = {top: j.top - h, left: j.left + j.width / 2 - b / 2};
                i = {top: j.top + j.height / 2 - h / 2, left: j.left - b};
                d = {top: j.top + j.height / 2 - h / 2, left: j.left + j.width};
                switch (f) {
                    case"bottom":
                        if ((l.top + h) > (a(window).scrollTop() + a(window).height())) {
                            if (c.top > a(window).scrollTop()) {
                                f = "top"
                            } else {
                                if ((d.left + b) < (a(window).scrollLeft() + a(window).width())) {
                                    f = "right"
                                } else {
                                    if (i.left > a(window).scrollLeft()) {
                                        f = "left"
                                    } else {
                                        f = "right"
                                    }
                ...
                g.offset(k).addClass(f).addClass("in")
            }).call(this.container())
        }})
}(window.jQuery));
(function (g) {
    ...
    h.prototype = {constructor: h, _process_options: function (n) {
            this._o = g.extend({}, this._o, n);
            var r = this.o = g.extend({}, this._o);
            var q = r.language;
            if (!b[q]) {
                q = q.split("-")[0];
                if (!b[q]) {
            ...
            var p = i.parseFormat(r.format);
            if (r.startDate !== -Infinity) {
                r.startDate = i.parseDate(r.startDate, p, r.language)
            }
            if (r.endDate !== Infinity) {
                r.endDate = i.parseDate(r.endDate, p, r.language)
            }
            r.daysOfWeekDisabled = r.daysOfWeekDisabled || [];
            if (!g.isArray(r.daysOfWeekDisabled)) {
                r.daysOfWeekDisabled = r.daysOfWeekDisabled.split(/[,\s]*/)
            }
            r.daysOfWeekDisabled = g.map(r.daysOfWeekDisabled, function (o) {
            ...
            if (this.isInput) {
                this._events = [[this.element, {focus: g.proxy(this.show, this), keyup: g.proxy(this.update, this), keydown: g.proxy(this.keydown, this)}]]
            } else {
                if (this.component && this.hasInput) {
                    this._events = [[this.element.find("input"), {focus: g.proxy(this.show, this), keyup: g.proxy(this.update, this), keydown: g.proxy(this.keydown, this)}], [this.component, {click: g.proxy(this.show, this)}]]
                } else {
                    if (this.element.is("div")) {
                        this.isInline = true
                    } else {
                        this._events = [[this.element, {click: g.proxy(this.show, this)}]]
                    }
                }
            }
            this._secondaryEvents = [[this.picker, {click: g.proxy(this.click, this)}], [g(window), {resize: g.proxy(this.place, this)}], [g(document), {mousedown: g.proxy(function (n) {
                            if (!(this.element.is(n.target) || this.element.find(n.target).size() || this.picker.is(n.target) || this.picker.find(n.target).size())) {
                                this.hide()
                            }
                        }, this)}]]
            ...
            var o = q || this.date, n = new Date(o.getTime() + (o.getTimezoneOffset() * 60000));
            this.element.trigger({type: p, date: n, format: g.proxy(function (s) {
                    var r = s || this.o.format;
                    return i.formatDate(o, r, this.o.language)
                }, this)})
        }, show: function (n) {
            if (!this.isInline) {
            ...
            this.setUTCDate(new Date(n.getTime() - (n.getTimezoneOffset() * 60000)))
            ...
            return i.formatDate(this.date, n, this.o.language)
            ...
            var p = parseInt(this.element.parents().filter(function () {
                return g(this).css("z-index") != "auto"
            }).first().css("z-index")) + 10;
            var o = this.component ? this.component.parent().offset() : this.element.offset();
            var n = this.component ? this.component.outerHeight(true) : this.element.outerHeight(true);
            this.picker.css({top: o.top + n, left: o.left, zIndex: p})
            ...
            this.date = i.parseDate(n, this.o.format, this.o.language);
            if (o) {
                this.setValue()
            }
            ...
            if (!n || !n.length) {
                ...
                this.range = g.map(n, function (o) {
                    return o.valueOf()
                })
            }
            this.fill()
        }, getClassNames: function (q) {
            var o = [], r = this.viewDate.getUTCFullYear(), s = this.viewDate.getUTCMonth(), n = this.date.valueOf(), p = new Date();
            ...
            if (q.valueOf() < this.o.startDate || q.valueOf() > this.o.endDate || g.inArray(q.getUTCDay(), this.o.daysOfWeekDisabled) !== -1) {
                o.push("disabled")
            }
            if (this.range) {
                ...
                if (g.inArray(q.valueOf(), this.range) != -1) {
                    o.push("selected")
                }
            }
            return o
        }, fill: function () {
            var F = new Date(this.viewDate), w = F.getUTCFullYear(), G = F.getUTCMonth(), A = this.o.startDate !== -Infinity ? this.o.startDate.getUTCFullYear() : -Infinity, E = this.o.startDate !== -Infinity ? this.o.startDate.getUTCMonth() : -Infinity, t = this.o.endDate !== Infinity ? this.o.endDate.getUTCFullYear() : Infinity, B = this.o.endDate !== Infinity ? this.o.endDate.getUTCMonth() : Infinity, u = this.date && this.date.valueOf(), q;
            ...
            this.updateNavArrows();
            this.fillMonths();
            var I = k(w, G - 1, 28, 0, 0, 0, 0), D = i.getDaysInMonth(I.getUTCFullYear(), I.getUTCMonth());
            I.setUTCDate(D);
            ...
            while (I.valueOf() < n) {
                if (I.getUTCDay() == this.o.weekStart) {
                    v.push("<tr>");
                    if (this.o.calendarWeeks) {
                        var o = new Date(+I + (this.o.weekStart - I.getUTCDay() - 7) % 7 * 86400000), r = new Date(+o + (7 + 4 - o.getUTCDay()) % 7 * 86400000), p = new Date(+(p = k(r.getUTCFullYear(), 0, 1)) + (7 + 4 - p.getUTCDay()) % 7 * 86400000), x = (r - p) / 86400000 / 7 + 1;
                        v.push('<td class="cw">' + x + "</td>")
                    }
                }
                z = this.getClassNames(I);
                z.push("day");
                var y = this.o.beforeShowDay(I);
                if (y === undefined) {
                    y = {}
                } else {
                    if (typeof (y) === "boolean") {
            ...
            r.preventDefault();
            var s = g(r.target).closest("span, td, th");
            if (s.length == 1) {
                switch (s[0].nodeName.toLowerCase()) {
                    case"th":
                        switch (s[0].className) {
                            ...
                            case"prev":
                            case"next":
                                var n = i.modes[this.viewMode].navStep * (s[0].className == "prev" ? -1 : 1);
                                switch (this.viewMode) {
                                    case 0:
    ...
    var m = function (o, n) {
        this.element = g(o);
        this.inputs = g.map(n.inputs, function (p) {
            return p.jquery ? p[0] : p
        });
        delete n.inputs;
        g(this.inputs).datepicker(n).bind("changeDate", g.proxy(this.dateUpdated, this));
        this.pickers = g.map(this.inputs, function (p) {
            return g(p).data("datepicker")
        });
        this.updateDates()
    };
    m.prototype = {updateDates: function () {
            this.dates = g.map(this.pickers, function (n) {
                return n.date
            });
            this.updateRanges()
        }, updateRanges: function () {
            var n = g.map(this.dates, function (o) {
                return o.valueOf()
            });
            g.each(this.pickers, function (o, q) {
                q.setRange(n)
            })
        }, dateUpdated: function (q) {
            var r = g(q.target).data("datepicker"), p = r.getUTCDate(), o = g.inArray(q.target, this.inputs), n = this.inputs.length;
            if (o == -1) {
                return
            }
            if (p < this.dates[o]) {
            ...
            g.map(this.pickers, function (n) {
                n.remove()
            });
            delete this.element.data().datepicker
        }};
    function f(q, t) {
        var s = g(q).data(), n = {}, r, p = new RegExp("^" + t.toLowerCase() + "([A-Z])"), t = new RegExp("^" + t.toLowerCase());
        for (var o in s) {
            if (t.test(o)) {
    ...
    var c = g.fn.datepicker;
    var j = g.fn.datepicker = function (q) {
        var o = Array.apply(null, arguments);
        o.shift();
        var p, n;
        this.each(function () {
            var y = g(this), w = y.data("datepicker"), s = typeof q == "object" && q;
            if (!w) {
                var u = f(this, "date"), r = g.extend({}, e, u, s), t = a(r.language), v = g.extend({}, e, t, u, s);
                if (y.is(".input-daterange") || v.inputs) {
                    var x = {inputs: v.inputs || y.find("input").toArray()};
                    y.data("datepicker", (w = new m(this, g.extend(v, x))))
                } else {
                    y.data("datepicker", (w = new h(this, v)))
                }
            }
    ...
    var e = g.fn.datepicker.defaults = {autoclose: false, beforeShowDay: g.noop, calendarWeeks: false, clearBtn: false, daysOfWeekDisabled: [], endDate: Infinity, forceParse: true, format: "mm/dd/yyyy", keyboardNavigation: true, language: "en", minViewMode: 0, rtl: false, startDate: -Infinity, startView: 0, todayBtn: false, todayHighlight: false, weekStart: 0};
    var l = g.fn.datepicker.locale_opts = ["format", "rtl", "weekStart"];
    g.fn.datepicker.Constructor = h;
    var b = g.fn.datepicker.dates = {en: {days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], daysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], daysMin: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"], months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], today: "Today", clear: "Clear"}};
    var i = {modes: [{clsName: "days", navFnc: "Month", navStep: 1}, {clsName: "months", navFnc: "FullYear", navStep: 1}, {clsName: "years", navFnc: "FullYear", navStep: 10}], isLeapYear: function (n) {
            return(((n % 4 === 0) && (n % 100 !== 0)) || (n % 400 === 0))
        }, getDaysInMonth: function (n, o) {
            return[31, (i.isLeapYear(n) ? 29 : 28), 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][o]
        }, validParts: /dd?|DD?|mm?|MM?|yy(?:yy)?/g, nonpunctuation: /[^ -\/:-@\[\u3400-\u9fff-`{-~\t\n\r]+/g, parseFormat: function (p) {
            var n = p.replace(this.validParts, "\0").split("\0"), o = p.match(this.validParts);
            ...
            if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(q)) {
                var C = /([\-+]\d+)([dmwy])/, t = q.match(/([\-+]\d+)([dmwy])/g), n, r;
                q = new Date();
                for (var v = 0; v < t.length; v++) {
                    ...
                    switch (n[2]) {
                        case"d":
                            ...
                            break;
                        case"m":
                            q = h.prototype.moveMonth.call(h.prototype, q, r);
                            break;
                        case"w":
                            q.setUTCDate(q.getUTCDate() + r * 7);
                            break;
                        case"y":
                            q = h.prototype.moveYear.call(h.prototype, q, r);
                            break
                    }
                }
                return k(q.getUTCFullYear(), q.getUTCMonth(), q.getUTCDate(), 0, 0, 0)
            }
            var t = q && q.match(this.nonpunctuation) || [], q = new Date(), y = {}, z = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], B = {yyyy: function (E, s) {
                    return E.setUTCFullYear(s)
                }, yy: function (E, s) {
                    return E.setUTCFullYear(2000 + s)
                }, m: function (E, s) {
                    s -= 1;
                    while (s < 0) {
                        s += 12
                    ...
                    s %= 12;
                    E.setUTCMonth(s);
                    while (E.getUTCMonth() != s) {
                        E.setUTCDate(E.getUTCDate() - 1)
                    }
                    return E
                }, d: function (E, s) {
                    return E.setUTCDate(s)
                }}, p, w, n;
            B.M = B.MM = B.mm = B.m;
            B.dd = B.d;
            ...
            if (t.length != x.length) {
                x = g(x).filter(function (s, E) {
                    return g.inArray(E, z) !== -1
                }).toArray()
            }
            if (t.length == x.length) {
                for (var v = 0, o = x.length; v < o; v++) {
                    ...
                    if (isNaN(p)) {
                        switch (n) {
                            case"MM":
                                w = g(b[u].months).filter(function () {
                                    var s = this.slice(0, t[v].length), E = t[v].slice(0, s.length);
                                    return s == E
                                });
                                p = g.inArray(w[0], b[u].months) + 1;
                                break;
                            case"M":
                                w = g(b[u].monthsShort).filter(function () {
                                    var s = this.slice(0, t[v].length), E = t[v].slice(0, s.length);
                                    return s == E
                                });
                                p = g.inArray(w[0], b[u].monthsShort) + 1;
                                break
                        }
                    }
                    y[n] = p
                }
                for (var v = 0, D; v < z.length; v++) {
                    D = z[v];
                    if (D in y && !isNaN(y[D])) {
                        B[D](q, y[D])
                    }
            ...
            return n.join("")
        }, headTemplate: '<thead><tr><th class="prev"><i class="icon-arrow-left"/></th><th colspan="5" class="datepicker-switch"></th><th class="next"><i class="icon-arrow-right"/></th></tr></thead>', contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>', footTemplate: '<tfoot><tr><th colspan="7" class="today"></th></tr><tr><th colspan="7" class="clear"></th></tr></tfoot>'};
    ...
    g.fn.datepicker.DPGlobal = i;
    g.fn.datepicker.noConflict = function () {
        g.fn.datepicker = c;
        return this
    };
    g(document).on("focus.datepicker.data-api click.datepicker.data-api", '[data-provide="datepicker"]', function (o) {
        var n = g(this);
    ...
    g(function () {
        j.call(g('[data-provide="datepicker-inline"]'))
    })
}(window.jQuery));
(function (b) {
    b.fn.bdatepicker = b.fn.datepicker.noConflict();
    if (!b.fn.datepicker) {
        b.fn.datepicker = b.fn.bdatepicker
    }
    var a = function (c) {
    ...
    b.fn.editableutils.inherit(a, b.fn.editabletypes.abstractinput);
    b.extend(a.prototype, {initPicker: function (c, d) {
            if (!this.options.viewformat) {
                this.options.viewformat = this.options.format
            }
            c.datepicker = b.fn.editableutils.tryParseJson(c.datepicker, true);
            this.options.datepicker = b.extend({}, d.datepicker, c.datepicker, {format: this.options.viewformat});
            this.options.datepicker.language = this.options.datepicker.language || "en";
            this.dpg = b.fn.bdatepicker.DPGlobal;
            ...
            return this.parseDate(c, this.parsedViewFormat)
        }, value2str: function (c) {
            return c ? this.dpg.formatDate(c, this.parsedFormat, this.options.datepicker.language) : ""
        }, str2value: function (c) {
            return this.parseDate(c, this.parsedFormat)
        }, value2submit: function (c) {
            return this.value2str(c)
        }, value2input: function (c) {
            this.$input.bdatepicker("update", c)
        }, input2value: function () {
            ...
            var c = null, e;
            if (f) {
                c = this.dpg.parseDate(f, d, this.options.datepicker.language);
                if (typeof f === "string") {
                    e = this.dpg.formatDate(c, d, this.options.datepicker.language);
                    if (f !== e) {
                        c = null
                    }
                }
    ...
    a.defaults = b.extend({}, b.fn.editabletypes.abstractinput.defaults, {tpl: '<div class="editable-date well"></div>', inputclass: null, format: "yyyy-mm-dd", viewformat: null, datepicker: {weekStart: 0, startView: 0, minViewMode: 0, autoclose: false}, clear: "&times; clear"});
...
(function (b) {
    ...
    a.defaults = b.extend({}, b.fn.editabletypes.date.defaults, {tpl: '<div class="input-group input-append date"><input type="text"/><span class="add-on input-group-addon"><i class="icon-th"></i></span></div>', inputclass: "input-small", datepicker: {weekStart: 0, startView: 0, minViewMode: 0, autoclose: true}});
...
(function (b) {
    ...
    a.defaults = b.extend({}, b.fn.editabletypes.datetime.defaults, {tpl: '<div class="input-group input-append date"><input type="text"/><span class="input-group-addon add-on"><i class="icon-th"></i></span></div>', inputclass: "input-medium", datetimepicker: {todayHighlight: false, autoclose: true}});
    b.fn.editabletypes.datetimefield = a
}(window.jQuery));
(function (a) {
    var b = function (c) {
        this.init("typeahead", c, b.defaults);
        this.options.typeahead = a.extend({}, b.defaults.typeahead, {matcher: this.matcher, sorter: this.sorter, highlighter: this.highlighter, updater: this.updater}, c.typeahead)
    };
    a.fn.editableutils.inherit(b, a.fn.editabletypes.list);
    a.extend(b.prototype, {renderList: function () {
        ...
        }, activate: a.fn.editabletypes.text.prototype.activate, renderClear: a.fn.editabletypes.text.prototype.renderClear, postrender: a.fn.editabletypes.text.prototype.postrender, toggleClear: a.fn.editabletypes.text.prototype.toggleClear, clear: function () {
    ...
    b.defaults = a.extend({}, a.fn.editabletypes.list.defaults, {tpl: '<input type="text">', typeahead: null, clear: true});
