...
(function (e, g, h, c) {
    ...
    var d = {listNodeName: "ol", itemNodeName: "li", rootClass: "dd", listClass: "dd-list", itemClass: "dd-item", dragClass: "dd-dragel", handleClass: "dd-handle", collapsedClass: "dd-collapsed", placeClass: "dd-placeholder", noDragClass: "dd-nodrag", emptyClass: "dd-empty", expandBtnHTML: '<button data-action="expand" type="button">Expand</button>', collapseBtnHTML: '<button data-action="collapse" type="button">Collapse</button>', group: 0, maxDepth: 5, threshold: 20};
    function i(m, l) {
        this.w = e(g);
        this.el = e(m);
    ...
    i.prototype = {init: function () {
            ...
            var m = this.mouse, p = e(q.target).closest("." + this.options.handleClass), o = p.closest(this.options.itemNodeName);
            console.log(p);
            ...
            this.dragEl.css({left: q.pageX - m.offsetX, top: q.pageY - m.offsetY});
            ...
            var t, x, n, q, p, m = this.options, u = this.mouse;
            this.dragEl.css({left: s.pageX - u.offsetX, top: s.pageY - u.offsetY});
            u.lastX = u.nowX;
            u.lastY = u.nowY;
            u.nowX = s.pageX;
            u.nowY = s.pageY;
            ...
            var r = this.pointEl.closest("." + m.rootClass), w = this.dragRootEl.data("nestable-id") !== r.data("nestable-id");
            if (!u.dirAx || w || o) {
