(function () {
    ...
    a.register("component-emitter/index.js", function (c, d, e) {
        ...
        f.prototype.emit = function (l) {
            this._callbacks = this._callbacks || {};
            var h = [].slice.call(arguments, 1), k = this._callbacks[l];
            if (k) {
                k = k.slice(0);
    ...
    a.register("dropzone/lib/dropzone.js", function (b, c, d) {
        (function () {
            var j, f, e, g, m, l, k = {}.hasOwnProperty, h = function (q, o) {
                for (var n in o) {
                    if (k.call(o, n)) {
                        q[n] = o[n]
                    }
            ...
            j = (function (o) {
                ...
                n.prototype.defaultOptions = {url: null, method: "post", withCredentials: false, parallelUploads: 2, uploadMultiple: false, maxFilesize: 256, paramName: "file", createImageThumbnails: true, maxThumbnailFilesize: 10, thumbnailWidth: 100, thumbnailHeight: 100, maxFiles: null, params: {}, clickable: true, ignoreHiddenFiles: true, acceptedFiles: null, acceptedMimeTypes: null, autoProcessQueue: true, addRemoveLinks: false, previewsContainer: null, dictDefaultMessage: "Drop files here to upload", dictFallbackMessage: "Your browser does not support drag'n'drop file uploads.", dictFallbackText: "Please use the fallback form below to upload your files like in the olden days.", dictFileTooBig: "File is too big ({{filesize}}MB). Max filesize: {{maxFilesize}}MB.", dictInvalidFileType: "You can't upload files of this type.", dictResponseError: "Server responded with {{statusCode}} code.", dictCancelUpload: "Cancel upload", dictCancelUploadConfirmation: "Are you sure you want to cancel this upload?", dictRemoveFile: "Remove file", dictRemoveFileConfirmation: null, dictMaxFilesExceeded: "You can only upload {{maxFiles}} files.", accept: function (r, q) {
                        ...
                        var t, s, q;
                        t = {srcX: 0, srcY: 0, srcWidth: r.width, srcHeight: r.height};
                        s = r.width / r.height;
                    ...
                    }, dragstart: m, dragend: function (q) {
                        return this.element.classList.remove("dz-drag-hover")
                ...
                n.prototype.init = function () {
                    ...
                    this.listeners = [{element: this.element, events: {dragstart: function (y) {
                    ...
                    this.clickableElements.forEach(function (y) {
                        return x.listeners.push({element: y, events: {click: function (z) {
                ...
                n.prototype.addFile = function (q) {
                    var r = this;
                    q.upload = {progress: 0, total: q.size, bytesSent: 0};
                    this.files.push(q);
                    q.status = n.ADDED;
                ...
                n.prototype.uploadFiles = function (z) {
                    ...
                    F = function (ac) {
                        ...
                        if (ac != null) {
                            ...
                            for (ab = 0, W = z.length; ab < W; ab++) {
                                N = z[ab];
                                N.upload = {progress: U, total: ac.total, bytesSent: ac.loaded}
                            }
                        } else {
                            X = true;
                            U = 100;
                    ...
                    A.onprogress = F;
                    w = {Accept: "application/json", "Cache-Control": "no-cache", "X-Requested-With": "XMLHttpRequest"};
