jQuery(function ($) {
    var grid_selector = "#task-grid-table";
    var pager_selector = "#task-grid-pager";

    jQuery(grid_selector).jqGrid({
        //direction: "rtl",
        url: "get_tl_task_data.php",
        datatype: "json",
        mtype: 'POST',
        height: '100%',
        width: 1471,
        colNames: ['', 'Project ID', 'Task ID', 'Task Name', 'Status', 'Priority', 'Description', 'Estimated Time', 'Start Date', 'Progress'],
        colModel: [
            ...
            {name: 'project_id', index: 'project_id', editable: true},
            {name: 'task_id', index: 'task_id', sortable: true, editable: true},
            {name: 'task_name', index: 'task_name', editable: true, },
            {name: 'status', index: 'status', editable: true},
            {name: 'priority', index: 'priority', editable: true},
            {name: 'description', index: 'description', editable: true},
            {name: 'estimated_time', index: 'estimated_time', editable: true},
            {name: 'start_date', index: 'start_date', editable: true},
            {name: 'progress', index: 'progress', editable: true}
        ],
        //rownumbers: true,
        //gridview: true,
        shrinkToFit: true,
        ...
        editurl: "update_task.php", //nothing is saved
