                                                        ...
                                                        <div class="modal-body overflow-visible">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-4" style="text-align:left"><label><b>Project Name<span class="red">*</span>:</b></label>
                                                                    <br>
                                                                    <input type="text" id="project_name"   value="" placeholder="IBCTimesheet" name="project_name" readonly autocomplete="on"/>
                                                                ...
                                                                <div class="col-sm-4" style="text-align:left"><label><b>Task Name<span class="red">*</span>:</b></label>
                                                                    <br>
                                                                    <input type="text" id="task_name" value="" placeholder="Task1" name="task_name" readonly autocomplete="on"/>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8" style="text-align:left"><label><b>Note</b></label>
                                                                    <br>
                                                                    <textarea  id="note"  style="width:370px;"  rows="4" cols="50"  name="note" value="" placeholder="Note" autocomplete="on"></textarea>
                                                                </div>
                                                                <div class="col-sm-2" ></div>
                                                            </div>						
                                                            <div class="space-4"></div>
